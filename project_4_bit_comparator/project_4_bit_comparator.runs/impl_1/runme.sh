...
HD_PWD='D:/programming/rtl projects/project_4_bit_comparator/project_4_bit_comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_comparator_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_comparator_4bit.tcl -notrace
