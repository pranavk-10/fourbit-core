...
HD_PWD='D:/programming/rtl projects/project_4_bit_comparator/project_4_bit_comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_comparator_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_comparator_4bit.tcl
