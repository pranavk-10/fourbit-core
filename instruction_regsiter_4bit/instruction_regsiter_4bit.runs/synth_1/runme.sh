...
HD_PWD='D:/programming/rtl projects/alu_4bit/instruction_regsiter_4bit/instruction_regsiter_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inst_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inst_reg.tcl
