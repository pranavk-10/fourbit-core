...
HD_PWD='D:/programming/rtl projects/alu_4bit/instruction_regsiter_4bit/instruction_regsiter_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inst_reg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inst_reg.tcl -notrace
